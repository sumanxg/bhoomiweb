...
<style type="text/css">
   ...
   <body class="top" id="page-top" data-spy="scroll" style="background-color:#fff9ed">
        ...
        <div id="slideout" style="z-index:999;"> <a href="#"><img src="images/group-logo-slider2.png" width="160" height="47"></a></div>
               ...
               <div class="col-sm-10 col-sm-offset-1">
                  ...
                  <div class="carousel slide carousel-fade" id="carousel-testimonials" data-ride="carousel">
                     ...
                     <div class="carousel-inner" role="listbox">
                        <div class="item active">
                           <img class="center-block" src="static/assets/img/home/07_portfolio/1.webp" alt="">
                        </div>
                        <div class="item">
                           <img class="center-block" src="static/assets/img/home/07_portfolio/2.webp" alt="">
                        </div>
                        <div class="item">
                           <img class="center-block" src="static/assets/img/home/07_portfolio/3.webp" alt="">
                        </div>
                        <div class="item">
                           <img class="center-block" src="static/assets/img/home/07_portfolio/4.webp" alt="">
                        </div>
                        <div class="item">
                           <img class="center-block" src="static/assets/img/home/07_portfolio/5.webp" alt="">
                        </div>
                     </div>
                  </div>
      ...
      <section  class="section-small3">
        ...
        <div class="row g-5 wrap-service-24">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card rounded card-shadow border-0 mb-4 double-border12">
                    <a href="javascript:void(0)" class="card-hover py-4 text-center d-block rounded"> 
                                               <img style="height:70px;width: 70px;margin-top: 20px;" src="images/decor.png">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card card-shadow border-0 mb-4 double-border12">
                    <a href="javascript:void(0)" class="card-hover py-4 text-center d-block rounded"> 
                          ...
                          <img style="height:70px;width: 70px;margin-top: 20px;" src="images/homecoming.png">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card card-shadow border-0 mb-4 double-border12">
                    <a href="javascript:void(0)" class="card-hover py-4 text-center d-block rounded"> 
                                         <img style="height:70px;width: 70px;margin-top: 20px;" src="images/weddingfavor.png">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card card-shadow double-border12 border-0 mb-4">
                    <a href="javascript:void(0)" class="card-hover py-4 text-center d-block rounded"> 
                                                <img style="height:70px;width: 70px;margin-top: 20px;" src="images/app.png">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card card-shadow border-0 mb-4 double-border12">
                    <a href="javascript:void(0)" class="card-hover py-4 text-center d-block rounded"> 
                                               <img style="height:70px;width: 70px;margin-top: 20px;" src="images/accomodation.png">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card card-shadow border-0 mb-4 double-border12">
                    <a href="javascript:void(0)" class="card-hover py-4 text-center d-block rounded"> 
                                                <img style="height:70px;width: 70px;margin-top: 20px;" src="images/logistics.png">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card card-shadow border-0 mb-4 double-border12">
                    <a href="javascript:void(0)" class="card-hover py-4 text-center d-block rounded"> 
                                               <img style="height:70px;width: 70px;margin-top: 20px;" src="images/assure.png">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card card-shadow border-0 mb-4 double-border12">
                    <a href="javascript:void(0)" class="card-hover py-4 text-center d-block rounded"> 
                                                <img style="height:70px;width: 70px;margin-top: 20px;" src="images/hospitality.png">
             ...
             <div class="col-lg-3 col-md-6">
                <div class="card card-shadow border-0 mb-4 double-border12">
                    <a href="javascript:void(0)" class="card-hover py-4 text-center d-block rounded"> 
                                               <img style="height:70px;width: 70px;margin-top: 20px;" src="images/entertainment.png">
             ...
             <div class="col-lg-3 col-md-6">
                <div class="card card-shadow border-0 mb-4 double-border12">
                    <a href="javascript:void(0)" class="card-hover py-4 text-center d-block rounded"> 
                                                <img style="height:70px;width: 70px;margin-top: 20px;" src="images/eat.png">
             ...
             <div class="col-lg-3 col-md-6">
                <div class="card card-shadow border-0 mb-4 double-border12">
                    <a href="javascript:void(0)" class="card-hover py-4 text-center d-block rounded"> 
                                                <img style="height:70px;width: 70px;margin-top: 20px;" src="images/events.png">
             ...
             <div class="col-lg-3 col-md-6">
                <div class="card card-shadow border-0 mb-4 double-border12">
                    <a href="javascript:void(0)" class="card-hover py-4 text-center d-block rounded"> 
                                              <img style="height:70px;width: 70px;margin-top: 20px;" src="images/rsvp.png">
            ...
            <div class="row wow fadeInUp" data-wow-duration="0s" data-wow-delay="2s">
               <div class="col-md-8 col-md-offset-2" style="text-align:center;">
                  ...
                  <div class="carousel slide carousel-fade" id="carousel-testimonials" data-ride="carousel">
                     ...
                     <div class="carousel-inner" role="listbox">
                        <div class="item active">
                           <img class="center-block" style="box-shadow:5px 5px 10px grey;" src="static/assets/img/home/06_what_they_say/1-Ritu & Jay.jpg" alt="">
                        ...
                        <div class="item">
                           <img class="center-block" style="box-shadow:5px 5px 10px grey;" src="static/assets/img/home/06_what_they_say/2-Batais -Mansi & Abhed.jpg" alt="">
                           <div class="carousel-caption">
                        ...
                        <div class="item">
                           <img class="center-block" style="box-shadow:5px 5px 10px grey;" src="static/assets/img/home/06_what_they_say/3-Sujit & Alisha.jpg" alt="">
                           <div class="carousel-caption">
                            <q style="font-size:60px;">
                        ...
                        <div class="item">
                           <img class="center-block" style="box-shadow:5px 5px 10px grey;" src="static/assets/img/home/06_what_they_say/4-Shreya & Hishant.jpg" alt="">
                           <div class="carousel-caption">
                            <q style="font-size:60px;">
                         ...
                         <div class="item">
                           <img class="center-block" style="box-shadow:5px 5px 10px grey;" src="static/assets/img/home/06_what_they_say/5-Hiral & Jainam.jpg" alt="">
                           <div class="carousel-caption">
                            <q style="font-size:60px;">
                        ...
                        <div class="item">
                           <img class="center-block" style="box-shadow:5px 5px 10px grey;" src="static/assets/img/home/06_what_they_say/6-Mr.Rajkumar Bansal - Ankur & Roopali.jpg" alt="">
                           <div class="carousel-caption">
                            <q style="font-size:60px;">
                        ...
                        <div class="item">
                           <img class="center-block" src="static/assets/img/home/06_what_they_say/7-Miloni & Nihar.jpg" alt="">
                           <div class="carousel-caption">
                            <q style="font-size:60px;">
                        ...
                        <div class="item">
                           <img class="center-block" style="box-shadow:5px 5px 10px grey;" src="static/assets/img/home/06_what_they_say/8-Onkar & Anisha.jpg" alt="">
                           <div class="carousel-caption">
                            <q style="font-size:60px;">
                        ...
                        <div class="item">
                           <img class="center-block" style="box-shadow:5px 5px 10px grey;" src="static/assets/img/home/06_what_they_say/9-Heena & Rohit.jpg" alt="">
                           <div class="carousel-caption">
                            <q style="font-size:60px;">
                        ...
                        <div class="item">
                           <img class="center-block" style="box-shadow:5px 5px 10px grey;" src="static/assets/img/home/06_what_they_say/10-Richa & Khushil.jpg" alt="">
                           <div class="carousel-caption">
                            <q style="font-size:60px;">
                        ...
                        <div class="item">
                           <img class="center-block" style="box-shadow:5px 5px 10px grey;" src="static/assets/img/home/06_what_they_say/11-Mrs. Emma & Ravi.jpg" alt="">
                           <div class="carousel-caption">
                            <q style="font-size:60px;">
                        ...
                        <div class="item">
                           <img class="center-block" style="box-shadow:5px 5px 10px grey;" src="static/assets/img/home/06_what_they_say/12-Mr.Khandewal - Nikita & Parth.jpg" alt="">
                           <div class="carousel-caption">
                            <q style="font-size:60px;">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="owl-carousel owl-theme clients-carousel">
          <div class="item box"><img alt="client logo" class="client-img" src="images/c1.png"></div>
          <div class="item box"><img alt="client logo" class="client-img" src="images/c2.png"></div>
          <div class="item box"><img alt="client logo" class="client-img" src="images/c3.png"></div>
          <div class="item box"><img alt="client logo" class="client-img" src="images/c4.png"></div>
          <div class="item box"><img alt="client logo" class="client-img" src="images/c5.png"></div>
          <div class="item box"><img alt="client logo" class="client-img" src="images/c6.png"></div>
          <div class="item box"><img alt="client logo" class="client-img" src="images/c7.png"></div>
          <div class="item box"><img alt="client logo" class="client-img" src="images/c8.png"></div>
          <div class="item box"><img alt="client logo" class="client-img" src="images/c9.png"></div>
        </div>
      </div>
    </div>
  </div>
     ...
     <?php include 'common/footer.php';?>
      ...
      <script src="static/assets/js/device.min.js"></script>
      ...
      <script src="static/assets/js/jquery.parallax.min.js"></script>
      <script src="static/assets/js/jquery.circle-progress.min.js"></script>
      <script src="static/assets/js/jquery.swipebox.min.js"></script>
      <script src="static/assets/js/smoothscroll.min.js"></script>
      <script src="static/assets/js/wow.min.js"></script>
      <script src="static/assets/js/jquery.smartmenus.js"></script>
      <script src="static/assets/js/main.js"></script>
      <script src="static/assets/js/owl/wow.js"></script>
      <script src="static/assets/js/owl/jquery.js"></script>
      <script src="static/assets/js/owl/imagesloaded.pkgd.js"></script>
      <script src="static/assets/js/owl/owl.carousel.min.js"></script>
      <script src="static/assets/js/owl/jquery.magnific-popup.js"></script>
      <script src="static/assets/js/owl/jquery.simple-text-rotator.min.js"></script>
      <script src="static/assets/js/owl/main.js"></script>
